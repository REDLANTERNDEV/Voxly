...
const textRoom: RoomSummary = { id: "general", serverId: "alpha", name: "General", kind: "text", categoryId: null, position: 10, isAfk: false };
const voiceRoom: RoomSummary = { id: "lobby", serverId: "alpha", name: "Lobby", kind: "voice", categoryId: null, position: 20, isAfk: false };
...
describe("channel state", () => {
  ...
  it("keeps visible and fallback rooms scoped to the active server", () => {
    const betaText: RoomSummary = { id: "beta-general", serverId: "beta", name: "general", kind: "text", categoryId: null, position: 10, isAfk: false };
